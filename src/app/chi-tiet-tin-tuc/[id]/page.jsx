          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-xl-9 col-lg-8 order-0 order-lg-2">
                    ...
                    <div className="blog__post-meta">
                      <ul className="list-wrap">
                        ...
                        <li>
                          ...
                          {moment(postDetail.created_at).format("DD/MM/YYYY")}
                        </li>
                        <li>
                      ...
                      <div className="row align-items-center">
                        <div className="col-md-7">
                          <div className="post-tags">
                            ...
                            <ul className="list-wrap">
                              <li>
                                <Link href="#">{postDetail.tags}</Link>
                              </li>
                            </ul>
                          </div>
                        </div>
                ...
                <div className="blog-avatar-wrap"></div>
                            ...
                            <div className="comments-box" key={datacomment.id}>
                              ...
                              <div className="comments-text">
                                <div className="avatar-name">
                                  <h6 className="name">{comment.full_name}</h6>
                                  <span className="date">
                    ...
                    <div className="rc-post-wrap">
                      {datapost.map((listpost) => (
                        <div className="rc-post-item" key={listpost.id}>
                          <div className="thumb">
                            <Link href={`../chi-tiet-tin-tuc/${listpost.id}`}>
                              <img src={`${listpost.image}`} alt="img" />
                            </Link>
                          </div>
                          <div className="content">
                            <h4 className="title">
                            ...
                            <span className="date">
                              <i className="flaticon-calendar"></i>
                              {moment(listpost.created_at).format("DD/MM/YYYY")}
                            </span>
                          </div>
                        </div>
                      ))}
