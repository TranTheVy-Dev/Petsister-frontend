...
import { usePost } from '../app/lib/api_post'; // Import custom hook
...
export default function Home() {
    ...
    const displayedPosts = [...posts].sort(()=> Math.random() - 0.5).slice(0, 3); // Chỉ lấy 12 sản phẩm đầu tiên
    const displayedProducts = [...products].sort(()=> Math.random() - 0.5).slice(0, 4); // Chỉ lấy 12 sản phẩm đầu tiên
    const displayedService = [...services].sort(()=> Math.random() - 0.5).slice(0, 3); // Chỉ lấy 12 sản phẩm đầu tiên
    return (
        <>
                                    ...
                                    <div className="product__item">
                                        <div className="product__thumb">
                                            ...
                                            <div className="product__add-cart">
                                                <Link href={`/chi-tiet-san-pham/${product.id}`} className="btn">
                                                    <i className="flaticon-shopping-bag"></i>Chi tiết sản phẩm
                                                </Link>
                                            </div>
                                        </div>
                                ...
                                <div className="why__we-are-img">
                                    <img
                                        style={{
                                            ...
                                            borderRadius: '20px',
                                            objectFit: "cover"
                                        }} src="img/images/why_we_are_img.png" alt="" />
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-md-4">
                                <div className="view__all-btn text-end mb-40">
                                    <Link href="/tin-tuc" className="btn btn-two">Xem tất cả bài viết <img src="img/icon/right_arrow.svg" alt="" className="injectable" /></Link>
                                </div>
                            </div>
                        </div>
                        <div className="row justify-content-center">
                            {displayedPosts.map((posts) => (  
                            <div className="col-lg-4 col-md-6 col-sm-8" key={posts.id}>
                                <div className="blog__post-item shine-animate-item">
                                    <div className="blog__post-thumb">
                                        <div className="blog__post-mask shine-animate">
                                            <Link href={`chi-tiet-tin-tuc/${posts.id}`}><img src={posts.image} alt="img" /></Link>
                                            <ul className="list-wrap blog__post-tag">
                                                <li><Link href="/tin-tuc">{posts.tags}</Link></li>
                                            </ul>
                                        </div>
                                        <div className="shape">
                                    ...
                                    <div className="blog__post-content">
                                        <div className="blog__post-meta">
                                            <ul className="list-wrap">
                                                <li><i className="flaticon-user"></i>By Admin</li>
                                                <li><i className="flaticon-calendar"></i>{moment(posts.created_at).format("DD/MM/YYYY")}</li>
                                            </ul>
                                        </div>
                                        <h2 className="title"><Link href={`chi-tiet-tin-tuc/${posts.id}`}>{posts.title}</Link></h2>
                                    </div>
                                </div>
                            </div>
                              ))}
